...
class FactStore(Protocol):
    ...
    def get_fact_admission_scope(self, fact_id: str, *, tenant_id: str | None = None) -> tuple[str, str] | None: ...
    def get_fact_decisions(self, conversation_id: str, *, limit: int = 100, before=None) -> list[dict]: ...

    def get_fact_admission_snapshot(self, fact_id: str, *, tenant_id: str | None = None) -> dict | None: ...
...
class StateStore(Protocol):
    ...
    def get_pending_exchange(self, conversation_id: str, exchange_id: str, *, now: float) -> str | None: ...
