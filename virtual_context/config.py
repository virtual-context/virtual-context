...
def _build_config(raw: dict[str, Any], *, validate: bool = True) -> VirtualContextConfig:
    ...
    assembler_config = AssemblerConfig(
        ...
        speaker_roster_enabled=assembly_raw.get("speaker_roster_enabled", _asm_defaults.speaker_roster_enabled),
        speaker_roster_max_tokens=assembly_raw.get("speaker_roster_max_tokens", _asm_defaults.speaker_roster_max_tokens),
