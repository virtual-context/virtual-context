...
from virtual_context.types import DomainDef, Message, VirtualContextConfig


@pytest.fixture
def sample_domains() -> list[DomainDef]:
    return [
        DomainDef(
            name="legal",
            description="Legal matters",
            keywords=["court", "filing", "motion", "attorney", "legal", "case", "judge"],
            patterns=[r"\bN\.?J\.?S\.?A\.?\b", r"\b\d{2}-cv-\d+"],
            priority=9,
            retrieval_limit=5,
        ...
        DomainDef(
            ...
            keywords=["insulin", "medication", "doctor", "lab", "blood", "glucose"],
            priority=8,
            retrieval_limit=3,
...
@pytest.fixture
def sample_config(sample_domains) -> VirtualContextConfig:
...
class MockLLMProvider:
    ...
    def __init__(self, response: str | None = None):
        ...
        self.response = response or '{"summary": "Test summary", "entities": ["entity1"], "key_decisions": ["decision1"], "action_items": [], "date_references": []}'
